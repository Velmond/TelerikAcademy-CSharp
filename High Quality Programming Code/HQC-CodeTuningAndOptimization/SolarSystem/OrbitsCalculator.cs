...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        {
            EarthRotationAngle = (360 * Days / EarthRotationPeriod) % 360;
            //// % 360 to avoid overflowing the EarthRotationAngle which would be pretty hard anyway but still...
            //// ... there are 360 degrees in an circle.
            Update("EarthRotationAngle");
        }

        private void SunRotation()
        {
            SunRotationAngle = (360 * Days / SunRotationPeriod) % 360;
            //// % 360 to avoid overflowing the SunRotationAngle which would be pretty hard anyway but still...
